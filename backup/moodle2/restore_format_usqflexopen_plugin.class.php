...
/**
 * Specialised restore for format_usqflexopen
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_usqflexopen_plugin extends restore_format_plugin {
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'usqflexopen' || !isset($data['tags']['numsections'])) {
