...
Feature: Sections can be edited and deleted in usqflexopen format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete usqflexopen
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | usqflexopen  | 0             | 5           | 957139200 |
  ...
  Scenario: View the default name of the second section in usqflexopen format
    When I click on "Edit week" "link" in the "li#section-2" "css_element"
    Then I should see "Use default section name [8 May - 14 May]"

  Scenario: Edit section summary in usqflexopen format
    When I click on "Edit week" "link" in the "li#section-2" "css_element"
    And I set the following fields to these values:
  ...
  Scenario: Edit section default name in usqflexopen format
  ...
  Scenario: Deleting the last section in usqflexopen format
  ...
  Scenario: Deleting the middle section in usqflexopen format
    Given I should see "29 May - 4 June" in the "li#section-5" "css_element"
  ...
  Scenario: Deleting the orphaned section in usqflexopen format
  ...
  Scenario: Deleting a section when orphaned section is present in usqflexopen format
    When I follow "Reduce the number of sections"
    Then I should see "Orphaned activities (section 5)" in the "li#section-5" "css_element"
